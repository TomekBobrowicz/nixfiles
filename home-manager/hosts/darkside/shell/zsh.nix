    ...
    file = {
      ".zshrc" = {
        text = ''
          ...
          alias fr="nh os switch  --hostname=darkside";
          alias fu="nh os switch --hostname=darkside --update";
          alias genrm="sudo nix-env -p /nix/var/nix/profiles/system --delete-generations old ; nix-collect-garbage -d ; nh os switch --hostname=darkside";
